...
export const hu: Dict = {
  ...
  'tour.title': 'Útmutató: az ízléstől a szabályokig',
  'tour.next': 'Tovább',
  'tour.prev': 'Vissza',
  'tour.step': 'Lépés',
  'tour.of': '/',
  ...
  'tour.explore.gamesBlurb':
    'Játsz a szabályokkal. Nézd meg, tényleg érted-e az egyes rendszerek előnyeit ezeken a gyakorlatokon keresztül.',
  ...
  'tour.s5.title': 'Szavazás a legközelebbire',
  'tour.s5.body':
    'A pontok választók. Vigyél fölé egyet: megjelenik a név, a preferencia, és a vonal a legközelebbi párthoz.',
  'tour.hoverHint': 'Vigyél az egérmutatót egy pontra',
...
export const en: Dict = {
  ...
  'tour.title': 'Tour: from taste to rules',
  'tour.next': 'Next',
  'tour.prev': 'Back',
  'tour.step': 'Step',
  'tour.of': 'of',
