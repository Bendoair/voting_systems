...
- Campaign length random **3–6 weeks**, peaked at **4**. Each week the player picks Party / Balanced / Own support; the field also moves. Intended effects are noisy (planned / fizzle / overperform).
